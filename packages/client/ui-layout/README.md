...
The sidebar grid cell rebinds the label aliases to sidebar-specific theme tokens before rendering its slot. A theme can therefore use a distinct sidebar fill without forcing the conversation column to inherit sidebar text colors or changing any child layout.
